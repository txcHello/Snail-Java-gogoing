package antlr;// Generated from G:/Snail-Java-gogoing/ANTLR/src/main/resources\JSON.g4 by ANTLR 4.12.0
...
public class JSONParser extends Parser {
	...
	@SuppressWarnings("CheckReturnValue")
	public static class ArrayOfValueContext extends ArrayContext {
		...
		public ArrayOfValueContext(ArrayContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof JSONListener) ((JSONListener)listener).enterArrayOfValue(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof JSONListener) ((JSONListener)listener).exitArrayOfValue(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof JSONVisitor) return ((JSONVisitor<? extends T>)visitor).visitArrayOfValue(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final ArrayContext array() throws RecognitionException {
		...
		try {
			...
			case 1:
				_localctx = new ArrayOfValueContext(_localctx);
				enterOuterAlt(_localctx, 1);
				{
				setState(33);
				match(T__4);
