...
public class ArrayIntParser extends Parser {
	...
	public static class ArrContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof ArrayIntListener) ((ArrayIntListener)listener).enterArr(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof ArrayIntListener) ((ArrayIntListener)listener).exitArr(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ArrayIntVisitor) return ((ArrayIntVisitor<? extends T>)visitor).visitArr(this);
	...
	public final ArrContext arr() throws RecognitionException {
		...
		enterRule(_localctx, 0, RULE_arr);
		int _la;
		try {
