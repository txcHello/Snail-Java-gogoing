...
public interface JSONListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code ArrayOfValue}
	 * labeled alternative in {@link JSONParser#array}.
	 * @param ctx the parse tree
	 */
	void enterArrayOfValue(JSONParser.ArrayOfValueContext ctx);
	/**
	 * Exit a parse tree produced by the {@code ArrayOfValue}
	 * labeled alternative in {@link JSONParser#array}.
	 * @param ctx the parse tree
	 */
	void exitArrayOfValue(JSONParser.ArrayOfValueContext ctx);
	/**
